...
const heroImage = teamImages.member2;import Header from "../Header";
const MainBlogHero = () => {
  return (
    <div
  ...
  >
     <div className="w-full bg-[#32210DB2]">
      ...
      <div className="w-[80%] h-full mx-auto max-w-[1200px]  md:pt-36 md:pb-56 pt-20 pb-32 flex flex-col gap-6 justify-start items-start">
        ...
        Unveiling the Charm of Uttarkashi Beauty: <br />
Exploring Exclusive Services
        </h1>
        <p className="text-[#E5E5E5] text-start text-[14px] leading-[20px] md:w-[50%] tracking-[-0.5px]">
        Ready to elevate your beauty experience? The Geeta Makeovers team is here to accompany you through every beauty transformation. Reach out today and let's embark on your journey to radiant confidence.
        </p>
        <p className="text-white text-start text-[12px] leading-[20px] md:w-[50%] tracking-[-0.5px]">
        By Geeta beauty parlor
        </p>
      </div>
      </div>
  </div>
