...
const HeroHome = () => {
  return (
    ...
    style={{
      ...
      backgroundPosition: "top center", // Focuses on the bride's head
    }}
    >
      ...
      GEEETA MAKEOVERS
          ...
          Artistry That Reflects Your True Beauty
From bridal elegance to personal glam, Geeta Makeovers brings out the best in you with a touch of artistry and years of expertise.
