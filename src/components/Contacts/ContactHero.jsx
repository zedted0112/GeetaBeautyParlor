...
const ContactHero = () => {
  return (
    <div className="w-full min-h-screen bg-cover bg-center overflow-hidden" style={{ 
      backgroundImage: `url('${heroImageContact}')`,
      backgroundPosition: 'top center'
    }}>
      <div className="w-full h-full bg-[#32210DB2]">
        <Header transparent={false} />
        <div className="w-[80%] mx-auto max-w-[1200px] md:pt-36 md:pb-56 pt-20 pb-32 flex flex-col gap-6 justify-center items-center">
