        ...
        <div className="w-full max-w-7xl mx-auto px-6 py-20 lg:py-32">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1 lg:max-w-2xl">
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">"Beauty begins the moment you decide to be yourself" - Coco Chanel</p>
              <p className="text-lg leading-relaxed mb-10 text-white/90">
                With over 15 years in the beauty industry, Geetha blends tradition with innovation to create personalized looks that celebrate your natural beauty. Whether it's for your big day or a special moment, each transformation is curated with luxury and love.<br/><br/>
                From intricate Indian bridal glam to chic contemporary styles — your look will be tailored, refined, and unforgettable. At Geetha Makeovers, we believe every woman deserves to feel like the most beautiful version of herself.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
                  <h4 className="text-xl font-semibold mb-3 text-white">🎨 Creative Vision</h4>
                  <p className="text-base text-white/80 leading-relaxed">Bespoke makeup artistry<br />Styles that reflect your personality</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-10 text-center">
                <p className="text-lg text-white/90 italic">"The most beautiful makeup of a woman is passion. But cosmetics are easier to buy." - Yves Saint Laurent</p>
              </div>
